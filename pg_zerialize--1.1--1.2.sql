-- pg_zerialize extension upgrade from 1.1 to 1.2.
-- Re-register APIs added during the 1.1 development cycle so deployed 1.1
-- installations have a complete, explicit upgrade path.
